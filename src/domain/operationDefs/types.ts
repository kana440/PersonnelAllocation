...
import type { EditCommand }    from '../operation/types'
 ...
 * src/domain/operationDefs/defs/ に配置する。
 *
 * 追加・調整のルール:
...
export interface OperationDef {
   ...
   * ここでは操作固有の初期値のみ返せばよい。
   */
  deriveInitial(row: AllocationRow, ctx: OperationContext): Partial<AllocationRow>
