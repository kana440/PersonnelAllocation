...
export function ChangeDigest({ data, onSelectTab }: Props) {
  ...
  const stats: Stat[] = [
    ...
    { label: '昇級',       value: summary.promotions,       color: 'text-green-600',  tab: 'grid',       filterKind: 'promotion' },
    { label: '降級',       value: summary.demotions,        color: 'text-orange-600', tab: 'grid',       filterKind: 'demotion' },
